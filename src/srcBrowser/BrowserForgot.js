...
import restaurantForgot from '../restaurantForgot.jpg';
...
{!this.state.mailSent &&
 ...
 <Text style={{marginTop:window.innerHeight*0.025, color: "#000", fontWeight: "500", fontSize: "1.5rem", paddingHorizontal: "5%", paddingBottom: window.innerHeight * 0.01, textAlign: "left", width: "100%" }}>
                    ...
                    No te preocupes si has olvidado la contraseña, te enviaremos un correo para que puedas recuperar tu cuenta 
                        </Text>
                    ...
                    <TextInput numberOfLines={1} placeholder={"restaurantegourmet@mail.com"} style={{marginBottom:window.innerHeight*0.02,fontSize:"1rem", width:"90%",alignSelf:"center",backgroundColor:"#f5f5f5",paddingHorizontal:window.innerWidth*0.01,paddingVertical:window.innerHeight*0.015}} />
 ...
 <Text style={{marginTop:window.innerHeight*0.025, color: "#000", fontWeight: "500", fontSize: "1.5rem", paddingHorizontal: "5%", paddingBottom: window.innerHeight * 0.01, textAlign: "left", width: "100%" }}>
                        ...
                        <Text style={{marginBottom:window.innerHeight*0.03,color: "#000", fontWeight: "400", fontSize: "1rem", paddingHorizontal: "5%", textAlign: "left", width: "100%" }}>
                    Pulsa en el enlace que encontrarás en el email que has recibido para restrablecer tu contraseña
                        </Text>
                        <Text style={{marginTop:window.innerHeight*0.01, color: "#000", fontWeight: "400", fontSize: "1rem", paddingHorizontal: "5%", paddingBottom: window.innerHeight * 0.02, textAlign: "left", width: "100%" }}>
                       Dirección de correo electrónico
                        </Text>
 ...
 <Image source={restaurantForgot} style={{width: window.innerWidth*0.65, height:window.innerHeight, zIndex: 0,opacity:1 }} resizeMode="cover" />
