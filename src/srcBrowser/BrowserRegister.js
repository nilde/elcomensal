...
export default class App extends React.Component {
    render() {
      ...
      return (
          ...
          <Image source={landing1} style={{position:"absolute",top:0,right:0,alignSelf:"center", width: window.innerWidth*1, height: "100%", zIndex: 0 }} resizeMode="cover" />
                        ...
                        <View style={{width:"35%",alignItems:"center",justifyContent:"center",backgroundColor:"#fff",marginLeft:window.innerWidth*0.025}}>
                        <Text style={{textDecorationLine:"underline",marginTop:window.innerHeight*0.025, color: "#000", fontWeight: "600", fontSize: "1.8rem", paddingHorizontal: "5%", paddingBottom: window.innerHeight * 0.01, textAlign: "left", width: "100%" }}>
        ...
        <View style={{width:"100%",backgroundColor:"#fff"}}>
                  ...
                  <View style={{width:"100%",justifyContent:"space-between",flexDirection:"row-reverse"}}>
                  <View style={{width:"50%",alignItems:"center",justifyContent:"center"}}>
                  <Text style={{paddingVertical:window.innerHeight*0.05, textDecorationLine:"underline", color: "#000", fontWeight: "600", fontSize: "1.8rem", paddingHorizontal: "5%", paddingBottom: window.innerHeight * 0.02, textAlign: "left", width: "100%"}}>
                  ...
                  <Text style={{color: "#000", fontWeight: "500", fontSize: "1.2rem", paddingLeft: "5%", paddingBottom: window.innerHeight * 0.02, textAlign: "left", width: "100%" }}>
                  Flexibilidad:
                  <Text style={{textDecorationLine:"none",color: "#000", fontWeight: "400", fontSize: "1.2rem", paddingHorizontal: window.innerWidth*0.01, paddingTop: window.innerHeight * 0.1, paddingBottom: window.innerHeight * 0.02, textAlign: "left", width: "100%" }}>
          ...
          <Image source={landing2} style={{alignSelf:"center", width: window.innerWidth*0.5,height:window.innerHeight*0.45, zIndex: 0 }} resizeMode="contain" />

                   </View>
  </View>
  <Text style={{backgroundColor:"#fff", textDecorationLine:"underline", color: "#000", fontWeight: "600", fontSize: "1.8rem", paddingHorizontal: "5%", paddingTop: window.innerHeight * 0.05, paddingBottom: window.innerHeight * 0.02, textAlign: "left", width: "100%" }}>
                  ...
                  <View style={{width:"100%",backgroundColor:"#fff"}}>
                  <Image source={frame} style={{alignSelf:"flex-start", width: window.innerWidth*0.3,height:window.innerHeight*0.3,  zIndex: 0,backgroundColor:"#fff" }} resizeMode="contain" />
                  </View>
                 ...
                 <Link to="/example" style={{width:"100%",height:"100%",justifyContent:"center",alignItems:"center"}}>
                  <Text style={{ textDecorationLine:"underline",color: "#fff", fontWeight: "400", fontSize: "1.2rem", paddingHorizontal: "5%", textAlign: "left",paddingVertical:window.innerHeight*0.02}}>
                  o pulsa aquí
                  </Text>
                  </Link>
                  </TouchableOpacity>
  ...
  <View style={{width:"100%",backgroundColor:"#fff"}}>
                  ...
                  <View style={{width:"100%",justifyContent:"space-between",flexDirection:"row-reverse"}}>
                  <View style={{width:"40%",alignItems:"center",justifyContent:"center",backgroundColor:"#fff",marginLeft:window.innerWidth*0.025}}>
                  <Text style={{textDecorationLine:"underline", color: "#000", fontWeight: "600", fontSize: "1.8rem", paddingRight: "5%", paddingTop: window.innerHeight * 0.1, paddingBottom: window.innerHeight * 0.02, textAlign: "left", width: "100%" }}>
                  ...
                  <Text style={{color: "#000", fontWeight: "500", fontSize: "1.2rem", paddingRight: "5%", paddingBottom: window.innerHeight * 0.1, textAlign: "left", width: "100%" }}>
                  5.Tus clientes escanean el código:
                  <Text style={{textDecorationLine:"none",color: "gray", fontWeight: "400", fontSize: "1.2rem", paddingHorizontal: window.innerWidth*0.01, paddingTop: window.innerHeight * 0.1, paddingBottom: window.innerHeight * 0.02, textAlign: "left", width: "100%" }}>
          ...
          <Image source={landing3} style={{alignSelf:"center", width: window.innerWidth*0.5,height:window.innerHeight*0.45,  zIndex: 0 }} resizeMode="contain" />

                   </View>
   
  </View>

  <Text style={{backgroundColor:"#000", textDecorationLine:"underline", color: "#fff", fontWeight: "600", fontSize: "1.8rem", paddingHorizontal: "5%", paddingTop: window.innerHeight * 0.05, paddingBottom: window.innerHeight * 0.02, textAlign: "left", width: "100%" }}>
...
<Image source={elcomensal} style={{  width: window.innerWidth*0.15, height: window.innerHeight*0.03, zIndex: 0 }} resizeMode="contain" />
         ...
         <TouchableOpacity onPress={()=>this.props.openSnackbar('Tu plato se ha creado con éxito. Puedes editar cúando quieras el plato y los cambios se reflejarán a tiempo real en la carta.')}  style={{alignSelf:"center", alignItems: "center", width: window.innerWidth*0.1,marginRight:window.innerWidth*0.01 }}>
                <View style={{ flexDirection: "row", width: "100%", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <TouchableOpacity onPress={()=>this.props.openSnackbar('Tu plato se ha creado con éxito. Puedes editar cúando quieras el plato y los cambios se reflejarán a tiempo real en la carta.')}  style={{alignSelf:"center", alignItems: "center", backgroundColor: "#000", width: window.innerWidth*0.1,marginRight:window.innerWidth*0.01 }}>
                <View style={{ flexDirection: "row", width: "100%", justifyContent: "space-between", alignItems: "center" }}>
